  ...
  return (
    <div className="min-h-screen">
      ...
      <main>
        ...
        <section className="relative py-20 md:py-32 bg-gradient-to-br from-stone-900 via-stone-800 to-stone-900 overflow-hidden">
          {/* Premium gold pattern overlay */}
          <div className="absolute inset-0 opacity-20">
            <div className="absolute inset-0" style={{
              backgroundImage: `radial-gradient(circle at 25% 25%, rgba(234,179,8,0.4) 0%, transparent 50%), radial-gradient(circle at 75% 75%, rgba(251,191,36,0.3) 0%, transparent 50%)`,
            }}></div>
          </div>
          {/* Gold shimmer effect */}
          ...
          <div className="container mx-auto px-4 relative z-10">
            <Link to="/" className="inline-flex items-center text-amber-200 hover:text-amber-300 mb-8 transition-colors">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="animate-fade-in-up">
                <div className="inline-flex items-center gap-2 bg-amber-500/20 text-amber-300 px-4 py-2 rounded-full text-sm font-semibold mb-6 border border-amber-500/30">
                  <Crown className="w-4 h-4" />
                  Imersão Presencial para Adultos
                </div>
                
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold text-white mb-6 leading-tight">
                  Imersão <span className="text-amber-400">Rumo à Liberdade</span>
                </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button 
                    ...
                    className="bg-gradient-to-r from-amber-500 to-yellow-500 hover:from-amber-600 hover:to-yellow-600 text-stone-900 font-bold shadow-lg"
                  >
                  ...
                  <Button 
                    ...
                    size="lg" 
                    asChild
                    className="border-2 border-amber-500/50 text-amber-300 hover:bg-amber-500/10 font-bold"
                  >
              ...
              <div className="relative animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                <div className="absolute -inset-4 bg-gradient-to-r from-amber-500/30 to-yellow-600/30 rounded-3xl blur-xl"></div>
                <img
                  src={rumoImage}
                  alt="Rumo à Liberdade"
                  className="relative rounded-3xl shadow-2xl w-full border-2 border-amber-500/40"
                />
              </div>
            </div>
          </div>
              ...
              {benefits.map((benefit, index) => {
                ...
                return (
                  <div key={index} className="text-center group">
                    <div className="w-20 h-20 mx-auto mb-4 bg-gradient-to-br from-amber-500 to-yellow-600 rounded-2xl flex items-center justify-center shadow-xl group-hover:scale-110 transition-transform">
                      <Icon className="w-10 h-10 text-white" />
                    </div>
                    <h3 className="font-heading font-bold text-stone-800">{benefit.title}</h3>
        ...
        {/* Stats Section */}
        <section className="py-12 bg-gradient-to-r from-stone-800 to-stone-900">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              <h3 className="text-2xl md:text-3xl font-heading font-bold text-white mb-6">
                Transformando <span className="text-amber-400">Vidas Financeiras</span>
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-white/10 rounded-2xl p-6 backdrop-blur-sm border border-amber-500/20">
                  <div className="text-3xl mb-2">📚</div>
                  <p className="text-stone-200 font-medium">Adultos aprendendo sobre investimentos</p>
                </div>
                <div className="bg-white/10 rounded-2xl p-6 backdrop-blur-sm border border-amber-500/20">
                  <div className="text-3xl mb-2">💰</div>
                  <p className="text-stone-200 font-medium">Economizando dinheiro de forma inteligente</p>
                </div>
                <div className="bg-white/10 rounded-2xl p-6 backdrop-blur-sm border border-amber-500/20">
                  <div className="text-3xl mb-2">📈</div>
                  <p className="text-stone-200 font-medium">Aprendendo a investir para o futuro</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
              {[
                ...
                { icon: Clock, label: "Duração", value: "20 horas", color: "text-yellow-600" },
                { icon: Award, label: "Período", value: "Sexta a Domingo", color: "text-amber-700" },
                { icon: MapPin, label: "Formato", value: "Presencial", color: "text-yellow-600" },
              ].map((item, index) => {
                const Icon = item.icon;
                return (
                  <div key={index} className="bg-white rounded-xl p-6 text-center shadow-lg border border-amber-200 hover:border-amber-400 transition-all hover:-translate-y-1">
                    <Icon className={`w-10 h-10 ${item.color} mx-auto mb-3`} />
                    <div className="text-sm text-amber-600 mb-1">{item.label}</div>
                    <div className="font-heading font-bold text-stone-800 text-lg">{item.value}</div>
                  </div>
                );
              })}
            </div>
        ...
        <section id="programa" className="py-20 bg-white">
          <div className="container mx-auto px-4 max-w-5xl">
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-center mb-12 text-stone-800">
              Sua jornada rumo à <span className="text-amber-600">liberdade financeira</span>
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div className="bg-gradient-to-br from-amber-50 to-yellow-50 rounded-2xl p-8 shadow-lg border border-amber-200 hover:shadow-xl transition-shadow">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-2xl font-heading font-bold text-stone-800">Comportamento Financeiro</h3>
                </div>
              ...
              <div className="bg-gradient-to-br from-yellow-50 to-amber-50 rounded-2xl p-8 shadow-lg border border-yellow-200 hover:shadow-xl transition-shadow">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-2xl font-heading font-bold text-stone-800">Economia e Mercado</h3>
                </div>
                <ul className="space-y-4">
                  {[
              ...
              <div className="bg-gradient-to-br from-amber-50 to-yellow-50 rounded-2xl p-8 shadow-lg border border-amber-200 hover:shadow-xl transition-shadow">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-2xl font-heading font-bold text-stone-800">Organização Financeira</h3>
                </div>
                <ul className="space-y-4">
                  {[
              ...
              <div className="bg-gradient-to-br from-stone-100 to-amber-100 rounded-2xl p-8 shadow-lg border border-stone-300 hover:shadow-xl transition-shadow">
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-12 h-12 bg-gradient-to-br from-stone-700 to-stone-800 rounded-xl flex items-center justify-center">
                    <Crown className="w-6 h-6 text-amber-400" />
                  </div>
                  <h3 className="text-2xl font-heading font-bold text-stone-800">Investimentos e Futuro</h3>
                </div>
                <ul className="space-y-4">
                  {[
                    ...
                    <li key={index} className="flex items-start gap-3">
                      <div className="w-6 h-6 rounded-full bg-stone-700 flex items-center justify-center flex-shrink-0 mt-0.5">
            ...
            <div className="bg-gradient-to-r from-amber-100 via-yellow-100 to-amber-100 rounded-2xl p-8 mb-12 border border-amber-300">
              <h3 className="text-2xl font-heading font-bold mb-6 text-center text-stone-800">Diferenciais Exclusivos</h3>
              <div className="grid md:grid-cols-3 gap-6">
                {[
                  ...
                  <div key={index} className="text-center">
                    <div className="w-14 h-14 rounded-full bg-gradient-to-br from-amber-500 to-yellow-600 flex items-center justify-center mx-auto mb-3 shadow-lg">
        ...
        <section className="py-16 bg-gradient-to-br from-stone-800 to-stone-900">
          <div className="container mx-auto px-4 max-w-4xl">
            <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 md:p-12 text-center border border-amber-500/20">
              <h3 className="text-2xl md:text-3xl font-heading font-bold text-white mb-6">
                Por que participar da <span className="text-amber-400">Imersão</span>?
              </h3>
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                <div className="text-center">
                  ...
                  <p className="text-stone-200">Aprenda a <strong className="text-white">investir com segurança</strong></p>
                </div>
                <div className="text-center">
                  <div className="w-16 h-16 mx-auto mb-4 bg-amber-500 rounded-full flex items-center justify-center">
                    <span className="text-2xl">💰</span>
                  </div>
                  <p className="text-stone-200">Descubra como <strong className="text-white">economizar de verdade</strong></p>
                </div>
                <div className="text-center">
                  <div className="w-16 h-16 mx-auto mb-4 bg-amber-500 rounded-full flex items-center justify-center">
                    <span className="text-2xl">🎯</span>
                  </div>
                  <p className="text-stone-200">Construa seu caminho para a <strong className="text-white">liberdade financeira</strong></p>
                </div>
              </div>
        ...
        <section className="py-20 bg-amber-50">
          <div className="container mx-auto px-4 max-w-3xl">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl md:text-4xl font-heading font-bold text-stone-800">
                Tire suas dúvidas
              </h2>
            </div>
            ...
            <Accordion type="single" collapsible className="space-y-4">
              {faqs.map((faq, index) => (
                ...
                >
                  <AccordionTrigger className="px-6 py-5 text-left font-heading font-bold text-stone-800 hover:no-underline hover:text-amber-600">
                    {faq.question}
                  </AccordionTrigger>
                  <AccordionContent className="px-6 pb-5 text-stone-600">
                    {faq.answer}
                  </AccordionContent>
                </AccordionItem>
              ))}
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <Button 
              size="lg" 
              onClick={() => setIsModalOpen(true)}
              className="bg-gradient-to-r from-amber-500 to-yellow-500 hover:from-amber-600 hover:to-yellow-600 text-stone-900 font-bold text-lg px-8 py-6 shadow-xl"
            >
