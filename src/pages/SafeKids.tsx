...
const SafeKids = () => {
  ...
  return (
    <div className="min-h-screen">
      <Header />
      <main>
        {/* Hero Section - Turquesa/Ciano Vibrante */}
        <section className="relative py-20 md:py-32 bg-gradient-to-br from-cyan-500 via-teal-500 to-emerald-500 overflow-hidden">
          {/* Fun decorative elements */}
          <div className="absolute inset-0 overflow-hidden">
            <div className="absolute top-10 left-10 w-20 h-20 bg-yellow-300/30 rounded-full animate-pulse"></div>
            <div className="absolute top-32 right-20 w-12 h-12 bg-orange-300/30 rounded-full animate-bounce" style={{ animationDelay: '0.5s' }}></div>
            ...
            <div className="absolute top-1/2 right-10 w-8 h-8 bg-pink-300/30 rounded-full animate-bounce"></div>
            <div className="absolute bottom-32 right-1/3 w-24 h-24 bg-sky-300/20 rounded-full animate-pulse" style={{ animationDelay: '0.3s' }}></div>
            <div className="absolute top-1/4 left-1/3 w-10 h-10 bg-amber-300/25 rounded-full animate-bounce" style={{ animationDelay: '0.7s' }}></div>
          </div>
              ...
              <div className="animate-fade-in-up">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button 
                    size="lg" 
                    asChild
                    className="bg-white text-teal-600 hover:bg-white/90 font-bold shadow-lg"
                  >
        ...
        <section className="py-16 bg-gradient-to-b from-cyan-100 to-white relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-2xl mx-auto text-center">
              <div className="w-32 h-32 mx-auto mb-6 bg-gradient-to-br from-cyan-500 to-teal-500 rounded-full flex items-center justify-center shadow-xl animate-pulse">
        ...
        <section className="py-12 bg-cyan-50">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
              {[
                { icon: Users, label: "Idade", value: "7 a 14 anos", color: "text-cyan-500" },
                { icon: Clock, label: "Cada Trilha", value: "4 meses (12 semanas)", color: "text-teal-500" },
                { icon: Award, label: "Certificado", value: "Incluso", color: "text-emerald-500" },
                { icon: Check, label: "Formato", value: "Online/Presencial", color: "text-cyan-600" },
              ].map((item, index) => {
                const Icon = item.icon;
                return (
                  <div key={index} className="bg-white rounded-2xl p-6 text-center shadow-lg border-2 border-cyan-100 hover:border-cyan-300 transition-all hover:-translate-y-1">
        ...
        <section id="programa" className="py-20 bg-white">
          <div className="container mx-auto px-4 max-w-5xl">
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-center mb-4 text-gray-800">
              Trilhas de <span className="text-cyan-500">Aprendizagem</span> ✨
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              ...
              <div className="bg-gradient-to-br from-cyan-50 to-teal-50 rounded-2xl p-8 shadow-lg border-2 border-cyan-200 hover:shadow-xl transition-shadow">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <span className="text-xs font-semibold text-cyan-600 bg-cyan-100 px-2 py-1 rounded-full">TRILHA 1</span>
              ...
              <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-2xl p-8 shadow-lg border-2 border-orange-200 hover:shadow-xl transition-shadow">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <span className="text-xs font-semibold text-orange-600 bg-orange-100 px-2 py-1 rounded-full">TRILHA 2</span>
            ...
            {/* Diferenciais */}
            <div className="bg-gradient-to-r from-cyan-100 via-teal-100 to-emerald-100 rounded-2xl p-8 border border-cyan-200">
        ...
        {/* Testimonial Section */}
        <section className="py-16 bg-gradient-to-br from-cyan-500 to-teal-500">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 md:p-12 text-center">
              ...
              <div className="flex items-center justify-center gap-4">
                <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center">
                  <span className="font-bold text-cyan-500">AM</span>
                </div>
        ...
        <section className="py-20 bg-cyan-50">
          <div className="container mx-auto px-4 max-w-3xl">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 bg-cyan-100 text-cyan-600 px-4 py-2 rounded-full text-sm font-semibold mb-4">
            ...
            <Accordion type="single" collapsible className="space-y-4">
              {faqs.map((faq, index) => (
                <AccordionItem 
                  key={index} 
                  value={`item-${index}`}
                  className="bg-white rounded-2xl shadow-md border-2 border-cyan-100 overflow-hidden"
                >
                  <AccordionTrigger className="px-6 py-5 text-left font-heading font-bold text-gray-800 hover:no-underline hover:text-cyan-600">
                    {faq.question}
                  </AccordionTrigger>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <Button 
              size="lg" 
              asChild
              className="bg-gradient-to-r from-cyan-500 to-teal-500 hover:from-cyan-600 hover:to-teal-600 text-white font-bold text-lg px-8 py-6 shadow-lg"
            >
              <a href="https://forms.clickup.com/9013166793/f/8ckm0p9-733/LKETIYOASY407ACE1T" target="_blank" rel="noopener noreferrer">
